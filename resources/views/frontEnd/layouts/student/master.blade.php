	...
	<nav class="wsit-sidebar student">
		<div class="navbar-wrapper">
			...
			<div class="navbar-content">
              ...
              {{-- nav item end --}}
					<li class="wsit-item">
				    <a href="#" class="wsit-link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
				        <span class="wsit-icon"><i class="ti ti-home"></i></span>
        ...
        <li class="dropdown wsit-h-item drp-company">
          <a class="wsit-head-link dropdown-toggle arrow-none m-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
            <span class="theme-avtar">
              <img alt="#" src="{{asset(Auth::guard('student')->user()->image)}}" class="rounded border-2 border border-primary" style="width: 100%; height: 100%;" />
            </span>
	  ...
	  <div class="footer-wrapper">
	    <div class="py-1">
	      <span class="text-muted">
	        © Copyright {{date('Y')}} All Right Reserved. Developed by <a href="https://websolutionit.com/" target="_blank" class="develop_company">Websolution IT</a>
	      </span>
	    </div>
	  </div>
	</footer>

...
<section class="wsit-container">
	<div class="wsit-content">
		...
		<div class="page-content">
		    <div class="row">
    			<div class="col-sm-12">
                    <form action="{{ route('exams.update') }}" method="POST" 
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('exam_code') is-invalid @enderror"
                                                name="exam_code" value="{{$edit_data->exam_code }}" id="exam_code">
                                            @error('exam_code')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('marks') is-invalid @enderror"
                                                name="marks" value="{{$edit_data->marks }}" id="marks" required>
                                            @error('marks')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('cq') is-invalid @enderror"
                                                name="cq" value="{{$edit_data->cq }}" id="cq">
                                            @error('cq')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('mcq') is-invalid @enderror"
                                                name="mcq" value="{{$edit_data->mcq }}" id="mcq">
                                            @error('mcq')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>

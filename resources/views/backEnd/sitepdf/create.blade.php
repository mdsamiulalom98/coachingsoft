		...
		<div class="page-header">
			<div class="page-block">
			    <div class="row align-items-center justify-content-between">
			    	...
			    	<div class="col-auto">
			    		<div class="quick_btn">
                            <a href="{{route('sitepdfs.index')}}"><i class="ti ti-plus"></i> Manage</a>
                        </div>
			    	</div>
			    </div>
			</div>
		    ...
		    <div class="row">
    			<div class="col-sm-12">
    				<div class="card">
    					...
    					<div class="card-body">
    						<form action="{{ route('sitepdfs.store') }}" method="POST" class="row"
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group mb-3">
                                        <label for="last_date" class="form-label">Last Date <span>*</span></label>
                                        <input type="date" class="mydate form-control @error('last_date') is-invalid @enderror"
                                            name="last_date" value="{{old('last_date') }}" id="last_date" required="">
                                        @error('last_date')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>

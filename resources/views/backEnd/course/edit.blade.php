            ...
            <div class="page-block">
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto">
                        ...
                        <h4 class="m-b-10">Course Edit</h4>
                        </div>
                           <ul class="breadcrumb">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('total_class') is-invalid @enderror"
                                                name="total_class" value="{{ $edit_data->total_class }}" id="total_class" required>
                                            @error('total_class')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" placeholder="Duration/Schedule" class="form-control @error('time') is-invalid @enderror"
                                                name="time" value="{{$edit_data->time }}" id="time" required>
                                            @error('time')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" placeholder="Duration/Schedule" class="form-control @error('old_fee') is-invalid @enderror"
                                                name="old_fee" value="{{$edit_data->old_fee }}" id="old_fee">
                                            @error('old_fee')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" placeholder="Duration/Schedule" class="form-control @error('course_fee') is-invalid @enderror"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control select2" name="category" id="category" required>
                                                <option value="">Select..</option>
                                                 <option value="Academic" {{$edit_data->category == 'Academic' ? 'selected' : ''}}>Academic</option>
                                                 <option value="Admission" {{$edit_data->category == 'Admission' ? 'selected' : ''}}>Admission</option>
                                                 <option value="Academic & Admission" {{$edit_data->category == 'Academic & Admission' ? 'selected' : ''}}>Academic & Admission</option>
                                            </select>
                                            @error('category')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control select2" name="course_type" id="course_type" required>
                                                <option value="">Select..</option>
                                                 <option value="Online" {{$edit_data->course_type == 'Online' ? 'selected' : ''}}>Online</option>
                                                 <option value="Offline" {{$edit_data->course_type == 'Offline' ? 'selected' : ''}}>Offline</option>
                                            </select>
                                            @error('course_type')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"  class="form-control @error('video') is-invalid @enderror"
                                                name="video" value="{{ $edit_data->video }}" id="video" required>
                                            @error('video')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea type="file" class="summernote form-control @error('why_us') is-invalid @enderror"
                                                name="why_us" value="{{old('why_us') }}" id="why_us">{!! $edit_data->why_us !!}</textarea>
                                            @error('why_us')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>

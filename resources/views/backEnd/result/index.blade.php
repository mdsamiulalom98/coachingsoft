			    ...
			    <div class="row align-items-center justify-content-between">
			    	<div class="col-auto">
				    	<div class="page-header-title">
	             		<h4 class="m-b-10">Result Manage</h4>
	            		</div>
						   <ul class="breadcrumb">
			    	...
			    	<div class="col-auto">
			    		<div class="quick_btn">
                            <a href="{{route('results.create')}}"><i class="ti ti-plus"></i> New</a>
                        </div>
			    	</div>
			    </div>
			</div>
    				...
    				<div class="card">
    					...
    					<div class="card-body">
                            <div class="row ">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <select class="form-control select2 ajax_exam" name="session_id" id="session_id">

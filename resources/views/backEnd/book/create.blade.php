        				...
        				<div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            <label for="title" class="form-label">Book Name<span>*</span></label>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('total_page') is-invalid @enderror"
                                                name="total_page" value="{{old('total_page') }}" id="total_page" required>
                                            @error('total_page')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('stock') is-invalid @enderror"
                                                name="stock" value="{{old('stock') }}" id="stock" required>
                                            @error('stock')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            <label for="image" class="form-label">Image (Some Read) <span>*</span></label>

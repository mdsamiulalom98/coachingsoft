			    ...
			    <div class="row align-items-center justify-content-between">
			    	<div class="col-auto">
				    	<div class="page-header-title">
	             				<h4 class="m-b-10">Student Edit</h4>
		            		</div>
					   <ul class="breadcrumb">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control select2" name="batch_id" id="batch_id" required>
                                                ...
                                                <option value="{{$value->id}}"  {{$edit_data->batch_id == $value->id ? 'selected' : ''}}>{{$value->name}}</option>
                                                @endforeach
                                            </select>
                                            @error('batch_id')
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="date" class="customDate form-control " name="add_date" value="{{$edit_data->add_date}}" id="add_date" required>
                                            @error('add_date')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('bn_name') is-invalid @enderror"
                                                name="bn_name" value="{{$edit_data->bn_name }}" id="bn_name">
                                            @error('bn_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('nick_name') is-invalid @enderror"
                                                name="nick_name" value="{{$edit_data->nick_name }}" id="nick_name" >
                                            @error('nick_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('bn_nick_name') is-invalid @enderror"
                                                name="bn_nick_name" value="{{$edit_data->bn_nick_name }}" id="bn_nick_name">
                                            @error('bn_nick_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('roll_number') is-invalid @enderror"
                                                name="roll_number" value="{{$edit_data->roll_number }}" id="roll_number" required>
                                            @error('roll_number')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('phone_number') is-invalid @enderror"
                                                name="phone_number" value="{{$edit_data->phone_number }}" id="phone_number" required>
                                            @error('phone_number')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control customDate @error('dob') is-invalid @enderror"
                                                name="dob" value="{{$edit_data->dob }}" id="dob" required>
                                            @error('dob')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('present_address') is-invalid @enderror"
                                                name="present_address" value="{{$edit_data->present_address }}" id="present_address" required>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('permanent_address') is-invalid @enderror"
                                                name="permanent_address" value="{{$edit_data->permanent_address}}" id="permanent_address" required>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('father_name') is-invalid @enderror"
                                            name="father_name" value="{{$edit_data->father_name }}" id="father_name" required>
                                        @error('father_name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('father_phone') is-invalid @enderror"
                                            name="father_phone" value="{{$edit_data->father_phone }}" id="father_phone" required>
                                        @error('father_phone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('father_profession') is-invalid @enderror"
                                            name="father_profession" value="{{$edit_data->father_profession }}" id="father_profession">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('mother_name') is-invalid @enderror"
                                            name="mother_name" value="{{$edit_data->mother_name }}" id="mother_name" required>
                                        @error('mother_name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('mother_phone') is-invalid @enderror"
                                            name="mother_phone" value="{{$edit_data->mother_phone }}" id="mother_phone">
                                        @error('mother_phone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('mother_profession') is-invalid @enderror"
                                            name="mother_profession" value="{{$edit_data->mother_profession }}" id="mother_profession">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('local_guardian') is-invalid @enderror"
                                            name="local_guardian" value="{{$edit_data->local_guardian }}" id="local_guardian">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('lg_relation') is-invalid @enderror"
                                            name="lg_relation" value="{{$edit_data->lg_relation }}" id="lg_relation">
                                        @error('lg_relation')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
				    ...
				    <div class="row education-group mb-2">
				        <div class="col-sm-2">
				            <div class="form-group mb-3">
				                ...
				                <input type="text" name="education[{{ $index }}][institute]" value="{{ $education['institute'] ?? '' }}" class="form-control">
				            </div>
				        </div>
				        <div class="col-sm-2">
				            <div class="form-group mb-3">
				                <label for="board" class="form-label">Board</label>
				                <input type="text" name="education[{{ $index }}][board]" value="{{ $education['board'] ?? '' }}" class="form-control">
				            </div>
				        </div>
				        <div class="col-sm-2">
				            <div class="form-group mb-3">
				                <label for="year" class="form-label">Year</label>
				                <input type="text" name="education[{{ $index }}][year]" value="{{ $education['year'] ?? '' }}" class="form-control">
				            </div>
				        </div>
				        <div class="col-sm-2">
				            <div class="form-group mb-3">
				                <label for="roll" class="form-label">Roll</label>
				                <input type="text" name="education[{{ $index }}][roll]" value="{{ $education['roll'] ?? '' }}" class="form-control">
				            </div>
				        </div>
				        <div class="col-sm-2">
				            <div class="form-group mb-3">
				                <label for="reg" class="form-label">Reg</label>
				                <input type="text" name="education[{{ $index }}][reg]" value="{{ $education['reg'] ?? '' }}" class="form-control">
				            </div>
				        </div>
				        <div class="col-sm-2">
				            <div class="form-group mb-3">
				                <label for="gpa" class="form-label">GPA</label>
				                <input type="text" name="education[{{ $index }}][gpa]" value="{{ $education['gpa'] ?? '' }}" class="form-control">
				            </div>
				        </div>
				        <div class="col-sm-12 text-end">
				            <button type="button" class="btn btn-danger btn-sm remove-group {{ $index == 0 ? 'd-none' : '' }}" style="margin-top:0px">X</button>
				        </div>
				    </div>
				@endforeach
				</div>

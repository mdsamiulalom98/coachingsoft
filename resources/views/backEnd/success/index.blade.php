...
@section('title','Success Student Manage')
@section('content')
			    ...
			    <div class="row align-items-center justify-content-between">
			    	<div class="col-auto">
				    	<div class="page-header-title">
	             		<h4 class="m-b-10">Success Student</h4>
	            		</div>
						   <ul class="breadcrumb">
							  ...
							  <li class="breadcrumb-item active">
							    Success Student Manage
							  </li>
						   </ul>
				    </div>
			    	<div class="col-auto">
			    		<div class="quick_btn">
                            <a href="{{route('success_students.create')}}"><i class="ti ti-plus"></i> New</a>
                        </div>
			    	</div>
			    </div>
			</div>
...
<script>
   $(function(){
    var table = $('#data-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('success_students.index') }}",
        },
        pageLength: 50,
